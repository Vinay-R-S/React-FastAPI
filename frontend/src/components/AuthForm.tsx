...
//     <div className="w-full">
//       <div>
//         <h1 className="w-full text-center text-2xl font-extrabold text-white mb-6">ProUX</h1>
//       </div>
...
//               <FieldSet>
//                 <FieldLegend className="sr-only">{isSignUp ? "Sign Up" : "Login"}</FieldLegend>
//                 <FieldDescription>
//                   {isSignUp ? "Create your account to get started." : "Log in to access your account."}
//                 </FieldDescription>
...
//                 <a href="#" role="button" tabIndex={0} onClick={(e) => { e.preventDefault(); toggleMode(); }}
//                   className="text-black inline-flex items-center justify-center rounded-md text-sm font-medium p-0 h-auto hover:underline">
//                   {switchAction}
//                 </a>
//               </p>
